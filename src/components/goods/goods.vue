<template>
    <div class="goods">
        <div class="menu-wrapper" ref="menusWrapper">
            <ul>
                <li v-for="(item,index) in goods" :key="index" class="menu-item" :class="{'current':currentIndex === index}" @click="selectedmenu(index,$event)">
                 <span class="text">
        ...
        <div class="foods-wrapper" ref="foodWrapper">
            <ul>
                <li  v-for="item in goods" class="food-list food-list-hook" >
                    ...
                    <ul>
                        <li @click="selectDetailFood(food,$event)" v-for="food in item.foods" class="food-item">
                            <div class="icon">
                                <img :src="food.icon" />
                            </div>
                            <div class="content">
